...
<body class="container">
  ...
  <?php } elseif ($page_nbr == 2) { ?>
    <div class="card">
      <div class="card-body">
        ...
        <p>It is the contribution of the electrostatic foreces between the nucleï.</p>
        <div class="equation">
      ...
      <div class="card-body">
        ...
        <nav aria-label="Course navigation">
          <ul class="pagination justify-content-center pagination-lg">
            ...
            <li class="page-item"><a class="page-link" href="./moleculestructuretheory.php?pagenbr=4">Next : Solving the Schrödinger equation for molecule</a></li>
          </ul>
        </nav>
      </div>
    </div>
  <?php } elseif ($page_nbr == 4) { ?>
    <div class="card">
      <div class="card-body">
        <h2 class="std card-title">We can calculate an approximate solution to the Schrödinger Equation</h2>
        <p class="card-text">
  ...
  <?php } elseif ($page_nbr == 5) { ?>
    <div class="card">
      <div class="card-body">
        ...
        <nav aria-label="Course navigation">
          <ul class="pagination justify-content-center pagination-lg">
            <li class="page-item"><a class="page-link" href="./moleculestructuretheory.php?pagenbr=4">Back : Solving the Schrödinger equation for molecules</a></li>
  ...
  <?php } elseif ($page_nbr == 6) { ?>
    <div class="card">
      <div class="card-body">
        <h2 class="std card-title">The Möller-Plesset perturbation theory and configuration interaction:</h2>
        <p class="card-text">
